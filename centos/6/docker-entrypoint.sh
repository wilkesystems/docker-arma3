...
function main {
    ...
    while [ ! -f /usr/games/arma3/arma3server ] ; do
    ...
    if [ ! -f "/usr/games/arma3/battleye/beserver.cfg" -a -d /usr/games/arma3/battleye ]; then
        ...
        if [ -n "$ARMA3_BATTLEYE_MAX_PING" ]; then
